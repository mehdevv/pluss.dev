...
const projects = [
  {
    ...
    descriptionFr:
      "Cette page d'accueil est conçue pour présenter les services professionnels de rédaction offerts par un freelance, visant à attirer des clients potentiels à la recherche de contenu de haute qualité et orienté résultats. La page est visuellement attrayante, avec un design propre et moderne qui met en valeur l'expertise du freelance et la valeur qu'il peut apporter. L'objectif principal de la page est de communiquer la capacité du freelance à créer des textes convaincants qui captent l'attention, stimulent l'engagement et, en fin de compte, aident les entreprises à se développer.",
    image: "img/AC.png",
    technologies: [
